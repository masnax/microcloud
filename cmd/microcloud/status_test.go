	...
	cases := []struct {
	...
	}{
		{
			...
			expectedWarnings: []Warning{
				{Level: Error, Message: "Reliability risk: 3 systems are required for effective fault tolerance"},
				{Level: Warn, Message: "MicroOVN is not installed on micro01"},
				{Level: Warn, Message: "MicroCeph is not installed on micro01"},
			},
		...
		},
		{
			...
			expectedWarnings: []Warning{
				{Level: Error, Message: "Reliability risk: 3 systems are required for effective fault tolerance"},
				{Level: Warn, Message: "MicroOVN is not installed on micro01, micro02"},
				{Level: Warn, Message: "MicroCeph is not installed on micro01, micro02"},
			},
			expectedStatus: map[string]microTypes.MemberStatus{"micro01": microTypes.MemberOnline, "micro02": microTypes.MemberOnline},
		},
		{
			...
			expectedWarnings: []Warning{
				...
				{Level: Warn, Message: "MicroOVN is not installed on micro01, micro02"},
				{Level: Warn, Message: "MicroCeph is not installed on micro01, micro02"},
				{Level: Warn, Message: "micro02 is not available"},
			},
		...
		},
		{
			...
			expectedWarnings: []Warning{
				...
				{Level: Warn, Message: "MicroOVN is not installed on micro01, micro02"},
				{Level: Warn, Message: "MicroCeph is not installed on micro01, micro02"},
				{Level: Warn, Message: "micro01 is not available"},
				{Level: Warn, Message: "LXD upgrade in progress"},
			},
		...
		},
		{
			...
			expectedWarnings: []Warning{
				{Level: Error, Message: "Reliability risk: 3 systems are required for effective fault tolerance"},
				{Level: Error, Message: "LXD is not installed on micro02"},
		...
		},
		{
			...
			expectedWarnings: []Warning{
				...
				{Level: Warn, Message: "MicroCeph is not installed on micro02"},
			},
			expectedStatus: map[string]microTypes.MemberStatus{"micro01": microTypes.MemberOnline, "micro02": microTypes.MemberOnline},
		},
		{
		...
		},
		{
			...
			expectedWarnings: []Warning{
				{Level: Error, Message: "Reliability risk: 3 systems are required for effective fault tolerance"},
				{Level: Error, Message: "Data loss risk: MicroCeph OSD replication recommends at least 3 disks across 3 systems"},
				{Level: Warn, Message: "MicroOVN is not installed on micro01, micro02"},
			},
		},
		{
		...
		},
		{
			...
			expectedWarnings: []Warning{
				{Level: Warn, Message: "MicroOVN is not installed on micro01, micro02, micro03"},
				{Level: Warn, Message: "MicroCeph is not installed on micro01, micro02, micro03"},
			},
		},
		{
